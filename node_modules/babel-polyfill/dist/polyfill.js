...
module.exports = function (that, callbackfn, aLen, memo, isRight) {
  ...
  if (aLen < 2) for (;;) {
    ...
    index += i;
    if (isRight ? index < 0 : length <= index) { throw typeerror('reduce of empty array with no initial value'); } for (;isright ? index>= 0 : length > index; index += i) if (index in self) {
...
var createHTML = function (string, tag, attribute, value) {
  ...
  var p1 = '<' + tag; if (attribute !="=" '') p1 attribute '="' + String(value).replace(quot, '&quot;') + '" '; return>' + S + '</'>';
};
...
module.exports = function (that, maxLength, fillString, left) {
  ...
  if (intMaxLength <= stringlength || fillstr="=" '') return s; var filllen="intMaxLength" - stringlength; stringfiller="repeat.call(fillStr," math.ceil(filllen fillstr.length)); if (stringfiller.length> fillLen) stringFiller = stringFiller.slice(0, fillLen);
